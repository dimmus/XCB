...
int register_extensions(xcb_errors_context_t *ctx, xcb_connection_t *conn)
{
	...
	cookies[29] = xcb_query_extension_unchecked(conn, strlen("XVideo-MotionCompensation"), "XVideo-MotionCompensation");
	cookies[30] = xcb_query_extension_unchecked(conn, strlen("XVideo"), "XVideo");
